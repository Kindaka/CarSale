...
public class UpdateCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int madm = Integer.valueOf(request.getParameter("madm"));
        String tendm = request.getParameter("tendm");
//        Boolean trangthai = Boolean.parseBoolean(request.getParameter("trangthai"));
        CategoryDAO dao = new CategoryDAO();
        dao.update(new Category(madm, tendm, true));
        request.getRequestDispatcher("ListCategoryController").forward(request, response);
    }
