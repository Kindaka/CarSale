                ...
                <div class="row">
                    <div class="col-xl-3">
                        <div class="account-side-navigation">
                            ...
                            <a href="ListAccountController" class="filter-btn active" data-show=".dashboard">Account</a>
                    ...
                    <div class="col-xl-9">
                        <div class="">
                            ...
                            <a  href="createAccount.jsp" class="btn btn-info">Add</a>
                            <table class="table">
                                <thead>
                                    <tr class="top-tr">
                                        <th>id</th>
                                ...
                                <tbody>
                                    <c:forEach var="acount" items="${requestScope.ACCOUNT_LIST}">
                                    <form action="UpdateAccountController" method="post">
                                        <tr>
                                            <td>#${acount.id}</td>
                                            <td><input type="text" name="tentk" value="${acount.tentk}" /> </td>
                                            <td><input type="text" name="email" value="${acount.email}" /> </td>

                                            <td>
                                                <select name="trangthai">
                                                    <option value="${acount.trangthai}">${acount.trangthai}</option>
                                                    <option value="${!acount.trangthai}">${!acount.trangthai}</option>
                                                </select>
                                            </td>
                                            <td>
                                                <select name="nhomtk">
                                                    <c:forEach var="ga" items="${requestScope.GROUPACCOUNT_LIST}">
                                                        <option  ${ga.nhomtk == acount.nhomtk ? 'selected' : ''}  value="${ga.nhomtk}">${ga.mota}</option>
                                                    </c:forEach>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="hidden" name="id" value="${acount.id}" />
                                                <input type="hidden" name="matkhau" value="${acount.matkhau}" />
                                                <button type="submit" class="btn-small d-block">Update</button>      
                                                <br>
                                                <a href="DeleteAccountController?id=${acount.id}" class="btn-small d-block">Delete</a>
                                            </td>
                                        </tr>
                                    </form>
                                </c:forEach>
