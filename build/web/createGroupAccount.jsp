            ...
            <div class="page-path">
                <div class="container">
                    <div class="breadcrumbs-inner">
                        <h1 class="path-title">Nhat's Car</h1>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 mr-10">
                        <div class="register-form">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form  action="CreateGroupAccountController" method="post">
                                        <div class="form">
                                            <input type="text" class="form-control" name="mota" id="username" placeholder="description" required />
                                        </div>
                                        <div class="form">
                                            <button type="submit"  class="btn">Create</button>
                                            <a href="ListGroupAccountController"> <button type="button" style="background-color: darkgray" class="btn">Back</button></a>  
                                        </div>
                                    </form>
                                </div>
                            </div>
