                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form  action="CreateCategoryController" method="post">
                                        <div class="form">
                                            <input type="text" class="form-control" name="tendm" id="username" placeholder="name" required />
                                        </div>
                                        <div class="form">
                                            <button type="submit"  class="btn">Create</button>
                                            <a href="ListCategoryController"> <button type="button" style="background-color: darkgray" class="btn">Back</button></a>  
                                        </div>
                                    </form>
                                </div>
                            </div>
